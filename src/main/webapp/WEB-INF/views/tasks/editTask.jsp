        ...
        <div id="content">
            ...
            <div class="container-fluid">
                <form method="post" action='<c:url value="/editTask/${task.id}"/>'>
                    ...
                    <fmt:formatDate value="${task.creationDate}" pattern="yyyy-MM-dd" var="creationDate"/>
                    <input hidden class="form-control" type="date" name="creationDate" value="${creationDate}">
                            ...
                            <div class="card shadow mb-4">
                                <div class="card-header py-3">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-10">
                                            <select class="form-control" name="studentModel"
                                                    value="${task.studentModel.firstName} ${task.studentModel.lastName}">
                                                <option selected
                                                        value="${task.studentModel.id}">${task.studentModel.firstName} ${task.studentModel.lastName}</option>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-10">
                                            <fmt:formatDate value="${task.deadline}" pattern="yyyy-MM-dd" var="myDate"/>
                                            <input class="form-control" type="date" name="deadline" value="${myDate}">
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        <div class="col-sm-2">
                                            <label class="radio-inline">
                                                <input type="radio" ${task.color.equals("success") ? 'checked' : ''}
                                        ...
                                        <div class="col-sm-2">
                                            <label class="radio-inline">
                                                <input type="radio" ${task.color.equals("secondary") ? 'checked' : ''}
                                                       name="color" value="secondary">
                                                <i class="btn btn-secondary btn-circle btn-sm"></i> poziom mid</label>
                                        </div>
                                        <div class="col-sm-2">
                                            <label class="radio-inline">
                                                <input type="radio" ${task.color.equals("primary") ? 'checked' : ''}
                                                       name="color" value="primary">
                                                <i class="btn btn-primary btn-circle btn-sm"></i> poziom mid+</label>
                                        </div>
                                        <div class="col-sm-2">
                                            <label class="radio-inline">
                                                <input type="radio" ${task.color.equals("danger") ? 'checked' : ''}
                    ...
                    <div class="modal-dialog">
                        <div class="modal-content">
                            ...
                            <div class="modal-header">
                                <h4 class="modal-title">Czy na pewno chcesz usunąć taska?</h4>
                            ...
                            <div class="modal-footer">
                                ...
                                <form method="post" action='<c:url value="/delTask/${task.id}"/>'>
